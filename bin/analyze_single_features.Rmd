...
params:
  ...
  rlm_sign_hits: "Z:/Results/2025_July_Rebuttal/RLM/RLM_signif_hits.csv"
  color_theme: "Z:/omics/EM-seq_UU/analysis/themes_and_colors.R"
---
...
```{r}
protein_mappings <- read.csv('Z:/omics/Proteomics_IMTM/Upload_2023-03-03/Protein_mappings.csv', sep = ';')
protein_ipp_mapping <- read.delim('Z:/omics/Proteomics_IMTM/Upload_2025-05-22_IPP/IPP_featureAnnotation.txt')
mrna_mappings <- read.csv('Z:/omics/mRNAseq_FIMM/Mapping2Gene_symbol/Ensembl_mappings_Deseq.csv', row.names = 1)
lipid_mappings <- read.csv('Z:/omics/LipidomicsUntargeted_IMTM/Untargeted_Lipidomics_IMTM_LN_PutativelyAnnotatedOnly_POS_EATRIS_20220902_MetaDataFeature.txt', sep ='\t')
```
...
source('../SupportFunctions/PlotCor2.R')
```
...
pdf("Z:/Results/2025_July_Rebuttal/MetabolitesSex.pdf", width = 10, height = 10)
...
pdf("Z:/Results/2025_July_Rebuttal/VLCFASex.pdf", width = 10, height = 10)
do.call(grid.arrange, c(plot_list, ncol = 2))
dev.off()
```
