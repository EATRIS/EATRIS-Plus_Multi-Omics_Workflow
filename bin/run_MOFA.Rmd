...
# outfile = file.path(outdir, 'model.hdf5')
#MOFAobject.trained <- run_mofa(MOFAobject, outfile)
```


## Read/Write MOFA result
```{r}
model_file <- "Z:/Results/2025_July_Rebuttal/MOFA/model.hdf5"
MOFAobject.trained <- MOFA2::load_model(model_file)
```
